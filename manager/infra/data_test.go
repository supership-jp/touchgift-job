...
func TestData(t *testing.T) {
	...
	/*
		...
		scheduleID2, _ := rdbUtil.InsertScheduleWithStatus(campaignID2, "schedule2", startAt2, endAt2, "configured", "schedule_origin2", 100, "cpc", 1000, false)
		rdbUtil.InsertScheduleCreative(scheduleID2, creativeID2, 1)
		locationID2 := rdbUtil.InsertLocation("location2", "org1")
		rdbUtil.InsertScheduleLocation(scheduleID2, locationID2, 1)
		...
		rdbUtil.InsertScheduleSegment(scheduleID2, segmentID2, segmentKeyID2)

		// 3分後に始まり10分後に終わるスケジュール(item_category_idsは[])
		...
		scheduleID3, _ := rdbUtil.InsertScheduleWithStatus(campaignID3, "schedule3", startAt3, endAt3, "configured", "schedule_origin3", 100, "cpc", 1000, false)
		rdbUtil.InsertScheduleCreative(scheduleID3, creativeID3, 1)
		locationID3 := rdbUtil.InsertLocation("location3", "org1")
		rdbUtil.InsertScheduleLocation(scheduleID3, locationID3, 1)
	*/
}
